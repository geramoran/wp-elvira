			...
			<div class="container">
				<div class="row">
					<div class="col-span-4 taller-img">
						<iframe src="https://www.youtube.com/embed/JDb-a7WxYII" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
					</div>
					<div class="col-8 taller-info">
						<h2>Taller de Dalcroze</h2>
						<p class="taller-descripcion">Las mejores manos en actuar y la escuela de cine con títulos, cursos acelerados, y talleres intensivos. Las escuelas en la ciudad de Nueva York y LA.</p>
						<p class="taller-dato">Dirección: 868 Wilderman Ferry Apt. 991 </p>
						<p class="taller-dato">Fecha: 31 Jan 2018</p>
						<p class="taller-dato">Costo: $3,000</p>
						<p class="taller-dato">Informes al tel: 5555876524</p>
					</div>
				</div>
				<div class="row">
					<div class="col-span-4 taller-img">
						<img src="img/ej-cartel.png">
					</div>
					<div class="col-8 taller-info">
						<h2>Stanislavsky</h2>
						<p class="taller-descripcion">Las mejores manos en actuar y la escuela de cine con títulos, cursos acelerados, y talleres intensivos. Las escuelas en la ciudad de Nueva York y LA.</p>
